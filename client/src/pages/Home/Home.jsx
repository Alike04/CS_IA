  ...
  return (
    <div className="px-40 pt-20 font-roboto font-light mb-10">
      ...
      <div className="bg-orange-50 rounded pl-16 pr-16 py-2 mt-10">
        <h1 className="my-3 text-2xl italic">{"'" + quote["quote"] + "'"}</h1>
        <h3 className=" text-2xl italic text-right">{quote["author"]}</h3>
        <button
          onClick={() => {
            setQuote(
      ...
      <div className="flex justify-between mt-10">
        ...
        <div className=" w-[65%] border-2 rounded-md p-6">
          <h2 className="text-xl">For today</h2>
...
const HomeTask = () => {
  return (
    <>
      <div className="bg-gray-200 h-40 hover:bg-gray-100 duration-200 hover:scale-105 px-5 py-3">
...
const HomeBoard = () => {
  return (
    <>
      <div className="bg-gray-200 h-20 hover:bg-gray-100 duration-200 hover:scale-105 px-5 py-3">
        <h1 className="text-center text-xl">Board </h1>
      </div>
    </>
  );
